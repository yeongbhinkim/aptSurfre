...
public class PageCriteria {
	...
	public String toString() {
		return "PageCriteria [rc=" + rc + ", PAGE_COUNT_PER_PAGE=" + PAGE_COUNT_PER_PAGE + ", startPage=" + startPage
	...
	/**
	 * 이전페이지 요청페이지의 시작페이지 이전에 보여줄 레코드가 있으면 보이도록
	 * 
	 * @return
	 */
	...
	/**
	 * 다음페이지 요청페이지의 종료페이지 다음에 보여줄 레코드가 있으면 보이도록
	 * 
	 * @return
	 */

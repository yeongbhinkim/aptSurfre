...
public class RecordCriteria {
	...
	public String toString() {
		return "RecordCriteria [reqPage=" + reqPage + ", REC_COUNT_PER_PAGE=" + REC_COUNT_PER_PAGE + ", startRec="
				+ startRec + ", endRec=" + endRec + "]";
	}
